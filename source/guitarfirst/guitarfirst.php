   ...
   //==================================
    ...
    public function onParsePageLayout($page, $name) {
        if ($name=="feed") {
            ...
            if ($this->isRequestXml($page)) {
                ...
                $pages->limit($this->yellow->system->get("guitarfirstFeedPaginationLimit"));
                ...
                $pages->paginate($this->yellow->system->get("guitarfirstFeedPaginationLimit"));
    ...
    public function onParsePageExtra($page, $name) {
        ...
        if ($name=="header") {
            ...
            $output = "<link rel=\"alternate\" type=\"application/rss+xml\" title=\"" . $this->yellow->system->get("guitarfirstFeedTitle") . "\" href=\"$locationFeed\" />\n";
        }
        return $output;
    }
