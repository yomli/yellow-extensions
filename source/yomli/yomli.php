...
class YellowYomli {
    ...
    public function onParsePageLayout($page, $name) {
        if ($name=="feed") {
            ...
            if ($this->isRequestXml($page)) {
                ...
                $entriesMax = $this->yellow->system->get("yomliFeedPaginationLimit");
                ...
                $output .= "<channel>\r\n";
                $output .= "<atom:link href=\"".$this->yellow->page->getUrl().$this->yellow->lookup->normaliseArguments("page:".$this->yellow->system->get("yomliFeedFileXml"), false)."\" rel=\"self\" type=\"application/rss+xml\" />";
    ...
    public function onParsePageExtra($page, $name) {
        ...
        if ($name=="header") {
            ...
            $locationFeed .= $this->yellow->lookup->normaliseArguments("page:".$this->yellow->system->get("yomliFeedFileXml"), false);
